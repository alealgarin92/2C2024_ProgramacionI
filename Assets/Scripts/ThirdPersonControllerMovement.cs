...
public class ThirdPersonControllerMovement : MonoBehaviour
{
    ...
    [FormerlySerializedAs("walk_speed")]
    [Range(1.0f, 10.0f)]
    public float walkSpeed;
    [FormerlySerializedAs("run_speed_multiplier")]
    [Range(1.0f, 2.0f)]
    private float runSpeedMultiplier = 1.0f;
    [FormerlySerializedAs("crouch_walk_speed_multiplier")]
    [Range(0.0f, 1.0f)]
    private float crouchWalkSpeedMultiplier;
    [FormerlySerializedAs("crouch_run_speed_multiplier")]
    [Range(0.0f, 1.0f)]
    ...
    [FormerlySerializedAs("rotation_speed")]
    [Range(0.1f, 1.5f)]
    public float rotationSpeed;

    [FormerlySerializedAs("jump_force")]
    [Range(2.0f, 10.0f)]
